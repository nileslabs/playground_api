...
export function DocsHeader() {
  ...
  return (
    <>
      <header className="sticky top-0 z-40 w-full glass-header transition-colors">
        <div className="w-full px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-3 sm:gap-6 min-w-0">
            {/* Mobile Hamburger Toggle Button (opens docs sidebar) */}
            <button
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            ...
            <nav className="hidden lg:flex items-center gap-1">
              <Link
                href="/blog"
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-border-theme text-xs sm:text-sm font-semibold text-text-secondary hover:text-text-primary hover:bg-bg-tertiary transition-colors"
              >
      ...
      {/* Mobile Slide-Over Navigation Drawer for Documentation */}
      {mobileMenuOpen && (
        <div
          ...
          <div className="bg-bg-secondary border-b border-border-theme shadow-2xl p-4 max-h-[calc(100vh-4rem)] overflow-y-auto space-y-4 w-full">
            ...
            <div className="pt-2">
              ...
              >
                ...
                <kbd className="px-1.5 py-0.5 rounded bg-bg-secondary border border-border-theme text-[10px] text-text-muted">
                  ⌘K
                </kbd>
              </button>
            </div>
