...
export const apiCatalog: ResourceCatalogDef[] = [
  ...
  },
  {
    ...
    name: 'Authentication',
    singular: 'Auth',
    description: 'Fake JWT authentication login, user registration, token refresh, RBAC discovery, and profile inspection.',
    itemCount: 7,
    ...
    endpoints: [
      ...
      },
      {
        ...
        method: 'GET',
        path: '/auth/roles',
        title: 'Get RBAC Roles & Test Personas',
        description: 'Retrieve all supported RBAC roles (admin, editor, viewer, guest), descriptions, default scopes, and test credentials.',
        noListParams: true,
        responseExample: {
          success: true,
      ...
      },
      {
        ...
        title: 'Get Permission Matrix & Wildcard Scopes',
        description: 'Retrieve the granular permission matrix, allowed HTTP actions per role, and wildcard scope definitions.',
        noListParams: true,
        responseExample: {
          success: true,
          matrix: {
