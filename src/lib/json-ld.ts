    ...
    '@graph': [
      {
        ...
        alternateName: [
          ...
          'Mock Stripe Payment Gateway Sandbox',
          'Virtual Email and SMS Verification Inbox',
          'Mock WebSocket and Real-Time Chat Server',
          'Mock File Upload and Cloud Storage CDN',
          'Official TypeScript SDK for Mock API',
          'Browser DevTools Extension for Mock API',
        ],
      ...
      },
      {
        ...
        description:
          'Free, zero-configuration, stateful mock REST and GraphQL API sandbox for frontend developers, mobile testing, and AI coding agents. Features persistent per-session mutation overlays, mock payments, virtual inbox, WebSockets, latency simulation, and JWT auth.',
        offers: {
          '@type': 'Offer',
          price: '0',
          priceCurrency: 'USD',
        ...
        featureList: [
          ...
          'Mock Payment Gateway & Stripe Parity Simulation',
          'Virtual In-Browser Email & SMS Inbox for OTPs',
          'Multipart File Uploads & Cloud Storage CDN',
          'Real-Time WebSockets, Live Chat & SSE Streams',
          'GraphQL Real-Time Subscriptions over WS',
          'Official Zero-Dependency TypeScript SDK (playground-api)',
          'Chrome/Edge DevTools Companion Extension',
          'Role-Based Access Control (RBAC) & Scope Permissions',
          'Network Latency, Chaos & HTTP Error Simulation',
          'JWT Auth Simulation with Protected Routes & Expiry Testing',
          'Dynamic Schema-less Custom Collections',
          'Deterministic SVG Avatar Generator',
          'Shareable Sandbox URLs & Cross-Device QR Sync',
